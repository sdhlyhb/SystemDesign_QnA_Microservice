...
export default function () {
  ...
  const url = `http://localhost:3000/qa/questions/${randomQuestiontId}/answers`;
  const data = {
    body: `k6 stress testing post answer for question ${randomQuestiontId}`,
    name: 'k6_postAnswer',
    email: 'k6@gmail.com',
    photos: [`${randomQuestiontId}_img1`, `${randomQuestiontId}_img2`],
  };
